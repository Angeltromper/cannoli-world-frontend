        ...
        <homepage className="homepage-container">
            <div className="inner-container__reusable">
                ...
                <TextContainerResp>
                    ...
                    <h4>De Arabische oorsprong van de cannoli wordt ondersteund door het feit dat de stad Capitalises historisch verbonden is met de
                    ...
                    <h4>Werden cannoli voor het eerst gemaakt in een klooster in de buurt van Caltanissetta. Om het carnaval te vieren, "verzonnen"
                        de nonnen een buisvormig gebak gevuld met ricotta crème, chocoladeschilfers en gehakte hazelnoten.</h4>
                    ...
                    <h4>De aanleiding hiervan waren de voorbereidingen voor de festiviteiten die waren opgesteld voor 2 november,
                        de dag van aller zielen. Op deze dag zou de bisschop het klooster bezoeken, omdat zogezegd hij vele verhalen had gehoord over
